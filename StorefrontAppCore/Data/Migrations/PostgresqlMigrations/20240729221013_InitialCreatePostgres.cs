    ...
    public partial class InitialCreatePostgres : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StoreAccounts", x => x.AccountID);
                    table.ForeignKey(
                        name: "FK_StoreAccounts_Users_HolderID",
                        column: x => x.HolderID,
                        principalTable: "Users",
                        principalColumn: "UserID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KeyPIN = table.Column<string>(type: "character varying(5)", maxLength: 5, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentMethods_StoreAccounts_AccountID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShippingAddresses_StoreAccounts_AccountID",
                        column: x => x.AccountID,
                        principalTable: "StoreAccounts",
                        principalColumn: "AccountID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShoppingCarts_StoreAccounts_AccountID",
                        column: x => x.AccountID,
                        principalTable: "StoreAccounts",
                        principalColumn: "AccountID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Suppliers_StoreAccounts_AccountID",
                        column: x => x.AccountID,
                        principalTable: "StoreAccounts",
                        principalColumn: "AccountID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Wishlists_StoreAccounts_AccountID",
                        column: x => x.AccountID,
                        principalTable: "StoreAccounts",
                        principalColumn: "AccountID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeletedPaymentMethodID = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Orders", x => x.OrderID);
                    table.ForeignKey(
                        name: "FK_Orders_PaymentMethods_DeletedPaymentMethodID",
                        column: x => x.DeletedPaymentMethodID,
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Orders_StoreAccounts_BuyerID",
                        column: x => x.BuyerID,
                        principalTable: "StoreAccounts",
                        principalColumn: "AccountID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Reviews", x => new { x.AccountID, x.ProductID });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Reviews_StoreAccounts_AccountID",
                        column: x => x.AccountID,
                        principalTable: "StoreAccounts",
                        principalColumn: "AccountID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_DeletedPaymentMethodID",
                table: "Orders",
                column: "DeletedPaymentMethodID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShippingAddresses_AccountID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StoreAccounts_HolderID",
                table: "StoreAccounts",
                column: "HolderID");
